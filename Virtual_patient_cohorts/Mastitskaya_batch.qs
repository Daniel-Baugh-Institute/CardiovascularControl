...
#        name):
#
#SBATCH --job-name=lowVagal_medBRS
#
...
# in sequence below.
#
UD_EXEC matlab -nodisplay -batch VNS_response_differential
matlab_rc=$?
